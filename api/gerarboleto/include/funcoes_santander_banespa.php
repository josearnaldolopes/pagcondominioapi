...
//Acréscimos
// $acrescimo = formata_numero($splitvalor,10,0,"valor");
// $acrescimo = $splitvalor;
$acrescimo = "";
...
// $dadosboleto["codigo_barras"] = $bodycurl["ResponseDetail"]["Barcode"];
$dadosboleto["codigo_barras"] = $boleto["codigodebarras"];
//$dadosboleto["linha_digitavel"] = monta_linha_digitavel($linha);
// $dadosboleto["linha_digitavel"] = $bodycurl["ResponseDetail"]["DigitableLine"];
$dadosboleto["linha_digitavel"] = $boleto["linhadigitavel"];
...
//Guarda inicial
?><img src=https://api.pagcondominio.com/gerarboleto/imagens/p.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=https://api.pagcondominio.com/gerarboleto/imagens/b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=https://api.pagcondominio.com/gerarboleto/imagens/p.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=https://api.pagcondominio.com/gerarboleto/imagens/b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
<?php
$texto = $valor ;
if((strlen($texto) % 2) <> 0){
...
?>
    src=https://api.pagcondominio.com/gerarboleto/imagens/p.png width=<?php echo $f1?> height=<?php echo $altura?> border=0><img 
<?php
    if (substr($f,$i,1) == "0") {
      $f2 = $fino ;
    }else{
...
?>
    src=https://api.pagcondominio.com/gerarboleto/imagens/b.png width=<?php echo $f2?> height=<?php echo $altura?> border=0><img 
<?php
  }
}
...
// Draw guarda final
?>
src=https://api.pagcondominio.com/gerarboleto/imagens/p.png width=<?php echo $largo?> height=<?php echo $altura?> border=0><img 
src=https://api.pagcondominio.com/gerarboleto/imagens/b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=https://api.pagcondominio.com/gerarboleto/imagens/p.png width=<?php echo 1?> height=<?php echo $altura?> border=0> 
  <?php
} //Fim da fun��o
...
{ 
	...
	// 30 a 30  Dígito verificador do c�digo de barras
	// 31 a 34  Fator de vencimento (qtdade de dias desde 07/10/1997 até a data de vencimento)
	// 35 a 44  Valor do título
	
	// 1. Primeiro Grupo - composto pelo código do banco, código da moóda, Valor Fixo "9"
  ...
  $campo1 = substr($campo1, 0, 5).'.'.substr($campo1, 5);
	...
	// 2. Segundo Grupo - composto pelas 3 últimas posi�oes do PSK e 7 primeiros dígitos do Nosso Número
